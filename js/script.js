...
const PROJECTS = [
  {
    id: 'soc-lab',
    category: 'cyber',
    image: 'Assets/img/1st-project.png',
  ...
  },
  {
    id: 'phishing',
    category: 'cyber',
    image: 'Assets/img/2nd-project.png',
  ...
  },
  {
    id: 'ransomware',
    category: 'cyber',
    image: 'Assets/img/3rd-project.png',
  ...
  },
  {
    id: 'otdr',
    category: 'telecom',
    image: 'Assets/img/4th-project.png',
  ...
  },
  {
    id: 'microwave',
    category: 'telecom',
    image: 'Assets/img/5th-project.png',
  ...
  },
  {
    id: 'ftth',
    category: 'telecom',
    image: 'Assets/img/6th-project.png',
...
function renderWork(filter) {
  ...
  list.forEach(p => {
    ...
    card.innerHTML = `
      <div class="work-visual viz-${p.category}"${p.image ? ` style="background-image:url('${p.image}')"` : ''}>
        ${p.image ? '' : ICONS[p.category]}
